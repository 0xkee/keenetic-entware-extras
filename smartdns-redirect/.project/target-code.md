...
В отличие от smartdns-geo-conf (который использует inline helpers), smartdns-redirect **source'ит** [`lib/common.sh`](../../lib/common.sh) для `log`, `log_error`, `require_cmd`, `file_mtime`.
