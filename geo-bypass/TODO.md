...
- [ ] сгенерировать белый список для ru (из белого списка ркн)
...
- [ ] сделать строгую(!) агрегацию соседних подсетей после скачивания geo базы, добавить опцию в конфиг - по умолчанию вкл
