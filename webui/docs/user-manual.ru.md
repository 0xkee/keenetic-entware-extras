...
- **Интерфейсы** — отображаются с человекочитаемыми именами (ppp0 → имя ISP-подключения, nwg1 → имя VPN-туннеля)
...
Диаграмма использует двухиконочную модель WAN-путей: 🌐 globe (ISP) + 🛡️ shield (VPN-туннель).
