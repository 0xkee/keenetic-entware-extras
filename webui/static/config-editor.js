...
var CONFIG_SCHEMAS = {
    ...
    'smartdns': [
        ...
        { key: 'ZONE_DNS_STRICT', label: 'Strict Zone Tunnel', type: 'toggle', hint: 'Privacy: fail if zone tunnel down',
          desc: 'When enabled: NO UDP fallback without tunnel — zone queries only via tunnel interface. Privacy over availability. Only meaningful when Zone Tunnel Interface is set.' },
