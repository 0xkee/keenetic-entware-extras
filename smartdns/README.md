...
DNS-сервер с разделением запросов по доменным группам для Keenetic-роутеров с Entware.
...
- **[geo-bypass](../geo-bypass/)** — маршрутизация трафика через VPN. Зависит от SmartDNS для резолвинга доменов (`dig @localhost` → порт 6053).
