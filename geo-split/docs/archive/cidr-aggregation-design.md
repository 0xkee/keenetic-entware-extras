...
> **⚠️ АРХИВ:** Awk-реализация, описанная ниже, заменена на ISC `aggregate` в апреле 2026.
> Причина: баг BusyBox `sort -n` (int32 overflow) терял ~904,704 IP (~2%) при агрегации.
...
Файл: [`geo-split/scripts/update-subnets.sh`](../scripts/update-subnets.sh)
