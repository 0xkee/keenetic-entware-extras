# Сравнение: geo-bypass vs ruantiblock
...
geo-bypass не имеет аналогичной оптимизации — загружает plain CIDR as-is.
...
| | **geo-bypass** | **ruantiblock** |
|---|---|---|
| **Кол-во ipsets** | 1 (`geo-bypass`, hash:net) | 5-7 (ip, ip-tmp, cidr, cidr-tmp, dnsmasq, onion, total-proxy) |
...
| **Init script** | S99geo-bypass (7 команд) | S40ruantiblock (5 команд) |
...
| Метрика | **geo-bypass** | **ruantiblock** |
|---------|:-:|:-:|
...
## 8. Что есть в ruantiblock, чего нет в geo-bypass
...
## 9. Что есть в geo-bypass, чего нет в ruantiblock
...
### Архитектурное превосходство geo-bypass
